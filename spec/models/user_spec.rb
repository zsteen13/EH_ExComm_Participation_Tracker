...
RSpec.describe User, :type => :model do
  ...
  describe '#to_s' do
    it 'returns a string version of a users profile' do
      ...
      expect(user.to_s).to eq('uin: 0 first_name: Zachary last_name Steen email: zsteen13@gmail.com committee: internal subcommittee: something total_point: 0 meeting_points: 0 event_points: 0 misc_points 0 admin: true'+"\n")
    end
  end
end
