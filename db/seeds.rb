...
users = User.create!(uin: '000000001', first_name: 'trev', last_name: 'moore', email: 'zsteen13@gmail.com', committee: 'internal', subcommittee: 'something', total_points:0, event_points:0, meeting_points:0, misc_points:0, admin: true)
...
UserToActivity.create(uin: 123456789, activity_id: activity2.id)
UserToActivity.create(uin: 000000000, activity_id: activity2.id)
UserToActivity.create(uin: 111111111, activity_id: activity2.id)
