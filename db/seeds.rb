...
users3 = User.create!(uin: '000000000', password_digest: BCrypt::Password.create('Test'), first_name: 'Johnson', last_name: 'Doe', email: 'johnson@fakeemail.com', committee: 1, total_points: 0, event_points: 0, meeting_points: 0, misc_points: 0, admin: true)
...
users5 = User.create!(uin: '000000001', password_digest: BCrypt::Password.create('Test'), first_name: 'Will', last_name: 'Smith', email: 'will@fakeemail.com', committee: 0, total_points: 0, event_points: 0, meeting_points: 0, misc_points: 0, admin: true)

users6 = User.create!(uin: '777777777', password_digest: BCrypt::Password.create('Test'), first_name: 'Kylie', last_name: 'Jenner', email: 'yoyoyo@aol.com', committee: 0, subcommittee: 1, total_points: 50, event_points: 10, meeting_points: 20, misc_points: 20, admin: true)
